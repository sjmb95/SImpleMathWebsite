...
<!--first left column containing blogs -->
    <div class="col-md-12"> <h1 style="text-align:center">FACTORIAL</h1></div>
      ...
      <form class="form-horizontal" action="" method="post"></form>
        ...
        <form class="form-horizontal" action="factorial.php" method="post">
          
            <label class="control-label col-sm-2" for="num">Enter Factorial  :</label>
            <div class="col-sm-10">
