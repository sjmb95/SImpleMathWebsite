...
function squareroot($n){
 ...
 echo ' &nbsp; &nbsp; '.$k.' iteration value is {'.$x1.'}   the Diff =  '.$diff.'<br>';
 $k=$k+1;
 $diff = floatval(abs( $n -  ($x1*$x1)));
 $x0 = $x1;
 }  

 echo'&nbsp; &nbsp; The value of the root is :  '.$x1.'';
...
<!--first left column containing blogs -->
    <div class="col-md-12"> <h1 style="text-align:center">SQUAREROOT F(X) = (X0 + N /X0)/2</h1></div>
      ...
      <form class="form-horizontal" action="fibonacci.php" method="post"></form>
        ...
        <form class="form-horizontal" action="squareroot.php" method="post">
