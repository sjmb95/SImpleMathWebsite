...
<!--first left column containing blogs -->
    <div class="col-md-12"> <h1 style="text-align:center">FIBONACCI</h1></div>
      ...
      <form class="form-horizontal" action="fibonacci.php" method="post"></form>
        ...
        <form class="form-horizontal" action="fibonacci.php" method="post">
          
            <label class="control-label col-sm-2" for="num">Enter number for fibonacci sequence :</label>
            <div class="col-sm-10">
